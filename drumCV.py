...
class Drums(object):
	...
	def initAnimation(self):
		...
		# SOUNDS
		#self.snareSound = pygame.mixer.Sound("sounds/snareShort.wav")
		self.snareSound = pygame.mixer.Sound("sounds/Ex_01.mp3")
		#self.highSound = pygame.mixer.Sound("sounds/highShort.wav")
		self.highSound = pygame.mixer.Sound("sounds/Ex_02.mp3")
		#self.tomSound = pygame.mixer.Sound("sounds/lowSnare.wav")
		self.tomSound = pygame.mixer.Sound("sounds/Ex_03.mp3")
		#self.smashSound = pygame.mixer.Sound("sounds/smash.wav")
		self.smashSound = pygame.mixer.Sound("sounds/Ex_04.mp3")
	...
	def drawDrums(self):
		...
		drumWidth, drumHeight, outlineWidth = 100, 250, 3

		highStart = (self.highX0, self.highY0) = (40, 400)
		...
		snareStart = (self.snareX0, self.snareY0) = (290, 400)
		...
		tomStart = (self.tomX0, self.tomY0) = (540, 400)
		...
		smashStart = (self.smashX0, self.smashY0) = (790, 400)
	...
	def trackRed(self):
		hsv = cv2.cvtColor(self.frame, cv2.COLOR_BGR2HSV)
		kernel = np.ones((5,5),np.uint8)
		lowerRed = np.array([5, 150, 150], dtype = np.uint8)
